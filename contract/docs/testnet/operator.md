...
near call stake.oysterpack.testnet force_update_config --accountId oysterpack.testnet --args '{"config":{"gas_config":{"callbacks":{"on_run_stake_batch":90000000000000}}}}'
```
